function [prediction] = netPredict(X, cnn, Theta3, Theta4, convolutionsStepSize, maxTopPredictions)
...
X = reshape(X, inputSizeL3, numTestImages);

prediction = mlpPredict(Theta3, Theta4, X, maxTopPredictions);
