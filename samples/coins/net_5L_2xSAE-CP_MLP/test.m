...
fprintf('Theta5: %u x %u \n', size(Theta5, 1), size(Theta5, 2));

% prediction test on cross validation dataset
prediction = testPrediction(imageDir, strcat(datasetDir, 'coin.cv.csv'), cnn, Theta4, Theta5, convolutionsStepSize, maxTestSamples, maxTopPredictions);
...
prediction = testPrediction(imageDir, strcat(datasetDir, 'coin.tst.csv'), cnn, Theta4, Theta5, convolutionsStepSize, maxTestSamples, maxTopPredictions);
...
prediction = testPrediction(imageDir, strcat(datasetDir, 'coin.tr.csv'), cnn, Theta4, Theta5, convolutionsStepSize, maxTestSamples, 1);
