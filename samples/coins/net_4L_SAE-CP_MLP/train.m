...
fprintf('\nL2 -> L3  %u -> %u \n', cnn{1}.outputWidth * cnn{1}.outputHeight * cnn{1}.outputChannels, inputSizeL5);
...
%                                   numClassesL4, inputSizeL3, softmaxLambda, ...
%                                   softmaxX, softmaxY), ...                                   
...
%    softmaxTheta = reshape(theta, numClassesL4, inputSizeL3);
