function pooledFeaturesTrain = convolveAndPool(shuffledX, sae1OptTheta, hiddenSizeL1, img_h, img_w, patchDim, meanPatch, poolDim, convolutionsStepSize)
...
trainImages = zeros(img_h, img_w, 1, size(shuffledX, 2));
%convImages(:, :, 1, :) = reshape(shuffledX(:, 1:8), img_h, img_w, 8);
trainImages(:, :, 1, :) = reshape(shuffledX, img_h, img_w, size(shuffledX, 2));
